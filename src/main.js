...
computed({
    menuList() {
        console.log('object');
        console.log(this.$store.state.auth.clickMenu);
...
//         userinfo = app.config.globalProperties.$GlobalFunctions.parseJwt(accessToken);
//         console.log(userinfo);
//     } else {
//         LogoutFunction.LogoutStoreClear();
//         router.push('/login');
...
const RefreshTokenInterval = import.meta.env.VITE_APP_RefreshTokenIntervalInMinutes * 1 * 300000;
